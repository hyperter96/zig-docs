  ...
  return (
    <Component
      className={clsx(
        ...
        'light:text-slate-400 prose prose-slate max-w-none dark:prose-invert prose-inline-code:rounded prose-inline-code:bg-stone-200 dark:prose-inline-code:bg-zinc-800',
        // headings
