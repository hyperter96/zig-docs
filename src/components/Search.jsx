...
const docSearchConfig = {
  ...
  indexName: process.env.NEXT_PUBLIC_DOCSEARCH_INDEX_NAME ? process.env.NEXT_PUBLIC_DOCSEARCH_INDEX_NAME : "hyperter96",
}
...
export function Search() {
  ...
  return (
    <>
      <button
        type="button"
        className="group flex h-6 w-6 items-center justify-center sm:justify-start md:h-auto md:w-80 md:flex-none md:rounded-lg md:py-2.5 md:pl-4 md:pr-3.5 md:text-sm md:ring-1 md:ring-slate-200 md:hover:ring-slate-300 dark:md:bg-zinc-800/75 dark:md:ring-inset dark:md:ring-white/5 dark:md:hover:bg-zinc-700/40 dark:md:hover:ring-slate-500 lg:w-96"
        onClick={onOpen}
      >
        <svg
          aria-hidden="true"
